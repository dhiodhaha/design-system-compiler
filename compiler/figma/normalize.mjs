...
const cssLines = [
  ...
  "/* Font: Inter 3.19 static (Inter-SemiBold). Chosen by glyph-run fingerprint match against the Figma SVG",
  "   export: Inter 4.x/Google-variable measured 76.594px for the specimen label where Figma measures 78px;",
