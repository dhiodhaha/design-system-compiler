/* Adopted from untitleduico/react@8b7409c078f8 — components/application/app-navigation/base-components/nav-button.tsx
 ...
 *
 * Base UI migration (branch migration/base-ui-v1.8): React Aria's `Pressable` is gone — this component exposes only
 * `onClick` (no `onPress`) and renders a native anchor, and the tooltip's trigger is the payload's migrated
 * `Tooltip` (the same composition `button-utility.tsx` uses). Every export, prop name and default is unchanged; the
 * unit record is .design-compiler/base-ui-migration/units/overlay-family.json. */
"use client";
