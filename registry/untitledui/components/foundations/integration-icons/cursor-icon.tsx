/* Adopted from untitleduico/react@8b7409c078f8 — components/foundations/integration-icons/cursor-icon.tsx
...
const CursorIcon = ({ grayscale, ...props }: SVGProps<SVGSVGElement> & { grayscale?: boolean }) => {
    return (
